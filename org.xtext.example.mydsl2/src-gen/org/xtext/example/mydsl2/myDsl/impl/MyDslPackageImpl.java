...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage
{
   ...
   */
  @Override
  public EReference getUse_DefRefs()
  {
   ...
   */
  @Override
  public EReference getDefRef_Def()
  {
    return (EReference)defRefEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(useEClass, USE__DEF_REFS);

    defRefEClass = createEClass(DEF_REF);
    createEReference(defRefEClass, DEF_REF__DEF);
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getModel_Defs(), this.getDef(), null, "defs", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getUse_DefRefs(), this.getDefRef(), null, "defRefs", null, 0, -1, Use.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(defRefEClass, DefRef.class, "DefRef", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getDefRef_Def(), this.getDef(), null, "def", null, 0, 1, DefRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
